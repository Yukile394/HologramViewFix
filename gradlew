...
#     be replaced by the value of the Hostname environment variable at the time of gradlew execution.
#   * All other arguments are considered dependent on shellness
